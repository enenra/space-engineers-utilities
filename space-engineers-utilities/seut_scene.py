...
def update_mod_path(self, context):
    ...
    if scene.render.filepath == "" or scene.render.filepath == '/tmp\\':
...
class SEUT_Scene(PropertyGroup):
    ...
    sceneType: EnumProperty(
        ...
        items=(
            ...
            ('planet_editor', 'Planet Editor', 'This scene can be used to create a Space Engineers planet with. Only one can exist per BLEND file'),
            ),
        default='mainScene',
