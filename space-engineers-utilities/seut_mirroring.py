...
mirroring_presets = OrderedDict([
    ...
    ('HalfY', (0.0, 0.0, -90.0)),
    ('HalfZ', (0.0, -90.0, 0.0)),
    # ('XMinusHalfZ', (0.0, 0.0, 0.0)),
    # ('YMinusHalfZ', (0.0, 0.0, 0.0)),
    # ('ZMinusHalfZ', (0.0, 0.0, 0.0)),
    # ('XMinusHalfX', (0.0, 0.0, 0.0)),
    # ('YMinusHalfX', (0.0, 0.0, 0.0)),
    # ('ZMinusHalfX', (0.0, 0.0, 0.0)),
    # ('ZThenOffsetX', (0.0, 0.0, 0.0)),
    # ('YThenOffsetX', (0.0, 0.0, 0.0)),
    # ('OffsetX', (0.0, 0.0, 0.0)),
    # ('ZThenOffsetXOdd', (0.0, 0.0, 0.0)),
    # ('YThenOffsetXOdd', (0.0, 0.0, 0.0)),
    # ('OffsetXOddTest', (0.0, 0.0, 0.0)),
